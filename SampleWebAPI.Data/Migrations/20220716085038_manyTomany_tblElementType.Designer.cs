...
namespace SampleWebAPI.Data.Migrations
{
    ...
    [Migration("20220716085038_manyTomany_tblElementType")]
    partial class manyTomany_tblElementType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.TypeEl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.TypeEl", b =>
                {
                    b.HasOne("SampleWebAPI.Domain.Sword", null)
                        .WithOne("TypeEl")
                        .HasForeignKey("SampleWebAPI.Domain.TypeEl", "SwordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
